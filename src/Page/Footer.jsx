      ...
      <footer className="bg-gray-800">
        <div className="container p-6 mx-auto">
          <div className="flex flex-wrap lg:flex-nowrap justify-between">
            {/* Left Section: Logo + Explore + Blog */}
            <div className="flex flex-wrap lg:flex-row gap-2 lg:w-2/3">
              {/* Logo */}
            ...
            <div className="w-full lg:w-1/3 mt-6 lg:mt-0">
              <h3 className="text-white "> Join our monthly newsletter 🙌</h3>
              
            
            

              {/* Input Field with Smaller Button and Arrow */}
              <div className="mt-4 relative">
                ...
                />
                <button className="absolute inset-y-0 right-1 top-1 bottom-1 px-4 py-1 flex items-center text-black bg-[#CCFF00] rounded-r-lg text-sm">
...
<div className="relative w-full h-64 flex items-end justify-center">
  <div className="absolute w-full h-full flex items-end justify-center">
    <h1
      className="font-secular text-6xl sm:text-8xl md:text-[15rem] text-gray-300 z-0 opacity-20"
      style={{
        position: "absolute",
        top: 25, // Positioning at the bottom
        left: "50%",
...
//   left: "50%",
//   transform: "translateX(-50%)",
//   clipPath: "inset(0 0 20% 0)", // Clips the top half
// }}
